function InstrumentsGalleryItem({ index, name, img, onClick }) {
  const itemContainerStyle =
    index % 2 == 0
      ? "flex-1 w-20 bg-highlights flex justify-center items-center group hover:cursor-pointer ease-linear duration-300 hover:drop-shadow-3xl lg:w-full"
      : "flex-1 w-20 bg-primary flex justify-center items-center group hover:cursor-pointer ease-linear duration-300 hover:drop-shadow-3xl lg:w-full";
  return (
    <div className={itemContainerStyle} onClick={onClick}>
      ...
      <div className="w-3/4 flex justify-center pl-4 md:pl-0 lg:w-1/2 lg:p-8">
        <img
          src={img}
